				...
				<div class="pd-20 card-box mb-30">
                    ...
                    @method('PUT')
						<div class="form-group row">
                            ...
                            <input type="text" name="nama" value="{{$pengarang->nama}}" class="form-control" placeholder="Nama" readonly>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Email</label>
							<div class="col-sm-12 col-md-10">
                            <input type="email" name="email"  value="{{$pengarang->email}}" class="form-control" placeholder="Email" readonly>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Hp</label>
							<div class="col-sm-12 col-md-10">
                            <input type="text" name="hp"  value="{{$pengarang->hp}}" class="form-control" placeholder="Hp" readonly>
							</div>
						</div>
						<div class="form-group row">
